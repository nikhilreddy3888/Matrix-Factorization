function [C, L, U] = SpectralClustering(data, k, Type)
...
%
%   'Data' - Data matrix, rows are data points
...
%[W] = CalculateAffinity(data);


W = SimGraph_NearestNeighbors(data', 21, 1, 1);
...
C = kmeans(U,k,'MaxIter',50,'OnlinePhase','off');
